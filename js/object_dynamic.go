...
type DynamicObject interface {
	...
	Set(key string, desc PropertyDescriptor) bool
...
func (o *dynamicObject) _set(prop string, desc PropertyDescriptor, throw bool) bool {
	if o.d.Set(prop, desc) {
		return true
	}
...
func (o *dynamicObject) setOwnStr(p unistring.String, v Value, throw bool) bool {
	...
	desc := PropertyDescriptor{Value: v}
	return o._set(prop, desc, throw)
}
...
func (o *dynamicObject) defineOwnPropertyStr(name unistring.String, desc PropertyDescriptor, throw bool) bool {
	return o._set(name.String(), desc, throw)
}
...
func (a *dynamicArray) checkDynamicObjectPropertyDescr(name fmt.Stringer, descr PropertyDescriptor, throw bool) bool {
	if descr.Getter != nil || descr.Setter != nil {
		a.val.runtime.typeErrorResult(throw, "Dynamic objects do not support accessor properties")
		return false
	}
	if descr.Writable == FLAG_FALSE {
		a.val.runtime.typeErrorResult(throw, "Dynamic object field %q cannot be made read-only", name.String())
		return false
	}
	if descr.Enumerable == FLAG_FALSE {
		a.val.runtime.typeErrorResult(throw, "Dynamic object field %q cannot be made non-enumerable", name.String())
		return false
	}
	if descr.Configurable == FLAG_FALSE {
		a.val.runtime.typeErrorResult(throw, "Dynamic object field %q cannot be made non-configurable", name.String())
		return false
	}
	return true
}
